...
<div class="leftarea">
	...
	<%String contextPath = request.getContextPath(); %>
   	<c:choose>
   		<c:when test='${currUser.userName eq "sysadmin"}'>
   			<div class="d1">
	            <div class="d2">
       ...
       <div class="d1">
        ...
        <div class="d1">
            ...
            <div class="dlist" style="display: none;">
            	 ...
            	 <div class="d3">
                    <a href="javascript:void(0)" onClick="window.parent.mainFrame.location='<%=contextPath%>/mission/goMissionListPage.do?searchType=1'"><div class="ds1">待处理的任务</div></a>
                </div>
                <div class="d3">
                    <a href="javascript:void(0)" onClick="window.parent.mainFrame.location='<%=contextPath%>/mission/goMissionListPage.do?searchType=2'"><div class="ds1">我发起的任务</div></a>
                </div>
            	<div class="d3">
                    <a href="javascript:void(0)" onClick="window.parent.mainFrame.location='<%=contextPath%>/mission/goMissionListPage.do?searchType=3'"><div class="ds1">我处理过的任务</div></a>
                </div>
            </div>
       	</div>
   		</c:otherwise>
