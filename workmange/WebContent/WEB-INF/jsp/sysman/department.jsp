...
<body>
	<div id="insertDiv" class="out"
		...
		<table width="98%" border="0" cellpadding="0" cellspacing="1"
			...
			<tr>
				<th style="text-align: right">部门描述：</th>
	...
	<div class="frame" style="position: absolute;">
		...
		<div id="lgdiv" style="display: block;" class="frame_cont">
			<div style="background: none;" class="frame_title">
				<span style="float: left;">部门列表</span> <span
					style="float: right; margin-right: 10px;"><a
					href="javascript:;" onclick="$('#insertDiv').mypop();">添加部门</a></span> <span
			...
			<div class=frame_table>
				<div class="cl"></div>
				<table id="depList" width="100%" border="0" cellpadding="0"
	...
	<script type="text/javascript" src="static/js/sysman/department.js"></script>
